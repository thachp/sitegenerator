...
/**
 * Class Lib_whois
 * Credit:  https://github.com/regru/php-whois
 */

class Lib_whois extends Lib_default {
  var $domain;
  var $tldname;
  var $domainname;
   ...
   * @return $this
   */
  public function look($domain_name) {
  ...
  public function is_available() {
    ...
    $array = preg_split("/:/", $not_found_string);
    if ($array[0] == "MAXCHARS") {
